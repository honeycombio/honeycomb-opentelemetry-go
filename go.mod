...
require (
	github.com/honeycombio/honeycomb-opentelemetry-go/components v0.0.0-00010101000000-000000000000
...
replace github.com/honeycombio/honeycomb-opentelemetry-go/components => ./components
